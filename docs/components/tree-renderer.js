 ...
 */
import { renderContentWithReferences } from './reference-link';
/**
...
export class TreeRenderer {
    ...
    `;
        ...
        renderContentWithReferences(node.content, this.tree.references, content, {
 ...
 */
export function renderConsultTree(tree, containerId, options) {
