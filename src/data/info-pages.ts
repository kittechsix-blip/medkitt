...
const AUB_COAG_SCREEN: InfoPage = {
  id: 'aub-coag-screen',
...
const AUB_ENDO_CANCER_RISK: InfoPage = {
...
const AUB_TREATMENT_TABLE: InfoPage = {
...
const AUB_MAINTENANCE: InfoPage = {
  id: 'aub-maintenance',
...
const HIV_STEPS_SUMMARY: InfoPage = {
...
const HIV_SEROCONVERSION_FEATURES: InfoPage = {
...
const HIV_ARV_CLASSES: InfoPage = {
  id: 'hiv-arv-classes',
...
const HIV_TESTING_GUIDE: InfoPage = {
...
const HIV_SYSTEM_COMPLICATIONS: InfoPage = {
...
const MENING_STEPS_SUMMARY: InfoPage = {
...
const MENING_CSF_GUIDE: InfoPage = {
  id: 'mening-csf-guide',
...
const MENING_CT_CRITERIA: InfoPage = {
...
const MENING_ABX_TABLE: InfoPage = {
  id: 'mening-abx-table',
...
const MENING_STEROID_GUIDE: InfoPage = {
...
const MENING_DISPO_CRITERIA: InfoPage = {
...
const MENING_PEP_GUIDE: InfoPage = {
  id: 'mening-pep-guide',
...
const SAH_ECG_CHANGES: InfoPage = {
  id: 'sah-ecg-changes',
...
const DELIRIUM_SUMMARY: InfoPage = {
  id: 'delirium-summary',
...
const DEL_PRECIPITANTS: InfoPage = {
  id: 'del-precipitants',
...
const DEL_VULNERABILITY: InfoPage = {
...
const DEL_VS_DEMENTIA: InfoPage = {
  id: 'del-vs-dementia',
...
const DEL_DEESCALATION: InfoPage = {
  id: 'del-deescalation',
...
const AB_COMPENSATION: InfoPage = {
  id: 'ab-compensation',
...
const AB_DIFFERENTIAL: InfoPage = {
  id: 'ab-differential',
...
const AB_LACTATE_KETONES: InfoPage = {
...
const AB_STEWART_EXPLAINED: InfoPage = {
...
const AB_FLUIDS_GUIDE: InfoPage = {
  id: 'ab-fluids-guide',
