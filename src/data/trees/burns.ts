...
export const BURNS_NODES: DecisionNode[] = [
...

  {
    ...
    recommendation: 'Superficial or small partial thickness <5% TBSA. Adequate oral pain control. Daily dressing changes (bacitracin + nonadherent). Keep elevated. Return if increasing pain/redness/drainage/fever. Follow-up 24-48h. Tetanus if >5y or unknown.',
    confidence: 'recommended',
    citation: [3, 4, 23],
  },
];
